...
\newcommand{\TypeEnvs}[1]{\Gamma#1,\Theta#1,\sigma}
\newcommand{\TypeEnvsPers}[3]{\Gamma#1,\Theta#2,\sigma#3}
\newcommand{\TypeEnvsws}[1]{\Gamma#1,\Theta#1}
\newcommand{\TypeEnvswsPers}[2]{\Gamma#1,\Theta#2}
\newcommand{\TypeEnvswt}[1]{\Gamma#1,\sigma}
\newcommand{\TypeEnvswtPers}[2]{\Gamma#1,\sigma#2}
\newcommand{\TypeEnvswst}[1]{\Gamma#1}
\newcommand{\TypeEnvswstPers}[1]{\Gamma#1}
