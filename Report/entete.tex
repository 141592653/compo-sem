...
\newcommand{\TypeEnvs}[1]{\Delta#1,\Theta#1,\delta}
\newcommand{\TypeEnvsPers}[3]{\Delta#1,\Theta#2,\delta#3}
\newcommand{\TypeEnvsws}[1]{\Delta#1,\Theta#1}
\newcommand{\TypeEnvswsPers}[2]{\Delta#1,\Theta#2}
\newcommand{\TypeEnvswt}[1]{\Delta#1,\delta}
\newcommand{\TypeEnvswtPers}[2]{\Delta#1,\delta#2}
\newcommand{\TypeEnvswst}[1]{\Delta#1}
\newcommand{\TypeEnvswstPers}[1]{\Delta#1}
