...
\AXCm{
\begin{array}{c} 
\upsilon_1 \preceq \tau_1\\
\vdots\\
\upsilon_n \preceq \tau_n\\
\end{array}
}

\LLm{}
\UICm{<\{serv_1 : \upsilon_1 ; ...; serv_n : \upsilon_n; ...; serv_p : : \upsilon_p\},\_ > \preceq <\{serv_1 : \tau_1 ; ...; serv_n : \tau_n\}, \_>}
...
\LLm{Var_{descr}}
\RLm{v\notin Dom(\Theta)}
\UICm{\TypeEnvs{} \vdash v : \Delta(\delta)(v)}
\end{prooftree}
\vspace{0cm}

\begin{prooftree}
\AXCm{\begin{array}{c}
\TypeEnvs{}\vdash expr : T \\
\TypeEnvs{} \vdash arg_1 : T_1  \\
\vdots\\
\TypeEnvs{} \vdash arg_n : T_n \\
\end{array}}

\AXCm{<(T_1,...T_n),T_{ret}> \preceq T\#interface(serv)}
\LLm{Call}
\BICm{\TypeEnvs{}\vdash expr.serv(arg_1,...arg_n) : T_{ret}}
\end{prooftree}
\vspace{0cm}


\begin{prooftree}
\AXCm{\TypeEnvs{}\vdash expr : T}
\LLm{At}
\UICm{\TypeEnvs{}\vdash port\textbf{@}expr :T}
\end{prooftree}
...
\AXCm{\TypeEnvs{}\vdash expr : T}
\LLm{Path}
\UICm{\TypeEnvs{}\vdash_{e}~!expr : T}
\end{prooftree}
\vspace{0cm}


\begin{prooftree}
\AXCm{\TypeEnvs{} \vdash \Delta(descr)\#arch : ()}
\LLm{New}
\UICm{\TypeEnvs{}\vdash descr.new() }
\end{prooftree}
...
\begin{prooftree}
\AXCm{\TypeEnvs{}\vdash_{p} prog1 : T }
\AXCm{\TypeEnvs{'}\vdash_{p} prog2 : U }
\LLm{Seq}
\BICm{\TypeEnvs{}\vdash_{p} prog1;prog2 : U}
\end{prooftree}
\vspace{0cm}
...
\AXCm{\TypeEnvs{}\vdash expr : T}
\LLm{Ret}
\UICm{\TypeEnvs{}\vdash \textbf{return}~expr : T}
\end{prooftree}
\vspace{0cm}
...
\AXCm{}
\LLm{Require}
\UICm{\TypeEnvs{}\vdash \textbf{require}~name:T : ()}
\end{prooftree}
\vspace{0cm}
...
\begin{prooftree}
\AXCm{\TypeEnvs{}\vdash_{e} expr_1 : T_1}
\AXCm{\TypeEnvs{'}\vdash_{e} expr_2 : T_2}
