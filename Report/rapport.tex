...
\LLm{Var_{descr}}
\RLm{v\notin Dom(\Theta)}
\UICm{\TypeEnvs{} \vdash v : \Gamma(\delta,v);\TypeEnvswst{}}
\end{prooftree}
\vspace{0cm}
...
\LLm{Call}
\UICm{\TypeEnvs{}\vdash expr.serv(arg_1,...arg_n) : T\#type(serv)\#ret;\TypeEnvswst{_n}}
\end{prooftree}
\vspace{0cm}
...
\end{prooftree}
\hspace{0.2cm} where $T' = \Delta(findProv(T)\#descr)(port)$
